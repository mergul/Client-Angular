...
export class AppComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        this.state$ = this.router.events
            ...
            if (!this.service.random) {
                this.service.random = Math.floor(Math.random() * (999999 - 100000)) + 100000;
            }
            this.newslistUrl = '/sse/chat/room/TopNews' + this.service.random + '/subscribeMessages';
        // this.router.events
        //     .pipe(
        ...
        this.zone.run(() => {
            this.winRef.nativeWindow.onload = () => {
                if (!this.reactiveService.statusOfNewsSource()) {
                    this.reactiveService.getNewsStream(this.service.random, this.newslistUrl);
                }
